  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const tempResponse = await fetch(`${API_BASE_URL}/api/temperature/current?device_id=${systemId}&zone_id=main`, {
          headers: {
        ...
        const historyResponse = await fetch(
          `${API_BASE_URL}/api/temperature/history?device_id=${systemId}&zone_id=main`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
        ...
        const metricsResponse = await fetch(`${API_BASE_URL}/api/status/metrics?system_id=${systemId}`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        })
